package com.adobe
{
	...
	{	
		...
		private var service:MediaWikiService;//The responder
		...
		private function initConnectedState():void{	
			loginModule.parentApplication.setCurrentState("Connected",true);
			loginModule.parentApplication.closeLogin();
		}
